...
'''This is the driver class to actual create the moive list and render
the moive trailer website.
...
socialnetwork = media.Movie("The Social Network",
    "Harvard student Mark Zuckerberg creates the social networking \
    site that would become known as Facebook, but is later sued by \
    two brothers who claimed he stole their idea, and the cofounder \
...
skyfall = media.Movie("Skyfall",
    "Bond's loyalty to M is tested when her past comes back to haunt \
    her. Whilst MI6 comes under attack, 007 must track down and \
...
kingsman = media.Movie("Kingsman: The Secret Service",
    ...
    kid into the agency's ultra-competitive training program, just as \
...
birdman = media.Movie("Birdman",
    ...
    in the days leading up to the opening of his Broadway play.",
